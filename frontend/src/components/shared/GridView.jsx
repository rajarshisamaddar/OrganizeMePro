        ...
        allTasks.map(
          (task) =>
            task.status === currentStatus && (
              <div
                key={task._id}
                className="h-[18rem] flex flex-col justify-between w-auto cursor-pointer 
              ...
              >
                ...
                <div
                  ...
                  className="mt-3 overflow-hidden border border-border flex-1 bg-background rounded-md"
                >
